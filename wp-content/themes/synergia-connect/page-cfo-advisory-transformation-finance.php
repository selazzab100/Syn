<?php
/**
 * CFO Advisory & Finance Transformation page.
 *
    ...
    <?php if ( $is_fr ) : ?>
      ...
      <ul class="service-list detailed">
        <li class="service-item">
          ...
          <ul>
            <li>Target Operating Model Finance et organisation cible.</li>
            <li>Rôles, responsabilités, RACI et délégations.</li>
            <li>Blueprint des processus clés (R2R, P2P, O2C, T&amp;E, Capex).</li>
          </ul>
        </li>
        <li class="service-item">
          <h3>Pilotage financier &amp; performance</h3>
          <ul>
            <li>Budgets, rolling forecasts et plan à moyen terme.</li>
            <li>Tableaux de bord et KPI (rentabilité, cash, ROCE).</li>
            <li>Contrôle de gestion et modèles de costing (ABC, standard cost).</li>
          </ul>
        </li>
        <li class="service-item">
          <h3>Clôture &amp; fiabilisation</h3>
          <ul>
            <li>Fast-close et amélioration du taux de conformité.</li>
            <li>Politiques et procédures du manuel Finance.</li>
            <li>Renforcement des contrôles internes essentiels (hors SOX).</li>
          </ul>
        </li>
      </ul>
      <div class="cta-wrap">
    ...
    <?php else : ?>
      ...
      <ul class="service-list detailed">
        ...
        <li class="service-item">
          ...
          <ul>
            <li>Budgets, rolling forecasts, and medium-term planning.</li>
            <li>Dashboards and KPIs (profitability, cash, ROCE).</li>
            <li>Management control and costing systems (ABC, standard cost).</li>
          </ul>
        </li>
        <li class="service-item">
